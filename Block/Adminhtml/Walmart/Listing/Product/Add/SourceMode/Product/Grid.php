...
/**
 * Class Grid
 * @package Ess\M2ePro\Block\Adminhtml\Walmart\Listing\Product\Add\SourceMode\Product
 */
class Grid extends \Ess\M2ePro\Block\Adminhtml\Magento\Product\Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        if ($hideParam || isset($this->listing['id'])) {
            ...
            if ($hideParam) {
                ...
                $dbExcludeSelect->where('`l`.`component_mode` = ?', \Ess\M2ePro\Helper\Component\Walmart::NICK);
            } else {
    ...
    protected function _toHtml()
    {
        ...
        $this->jsUrl->add(
            $this->getUrl('*/walmart_listing_product_add/add', ['_current' => true, 'step' => null]),
            'add_products'
        );
        ...
        $this->js->add(
            <<<JS
    require([
        'M2ePro/Walmart/Listing/Product/Add',
        ...
        AddListingObj = new WalmartListingProductAdd(ProgressBarObj, WrapperObj);
