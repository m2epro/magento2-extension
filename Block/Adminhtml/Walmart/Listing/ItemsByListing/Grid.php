...
HTML;
    ...
    protected function _toHtml()
    {
        ...
        $this->jsUrl->add($this->getUrl('*/walmart_listing_edit/selectStoreView'), 'listing/selectStoreView');
        $this->jsUrl->add($this->getUrl('*/walmart_listing_edit/saveStoreView'), 'listing/saveStoreView');
