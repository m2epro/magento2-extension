...
namespace Ess\M2ePro\Block\Adminhtml\Walmart\Order\Edit\ShippingAddress;

use Ess\M2ePro\Block\Adminhtml\Magento\Form\AbstractForm;

/**
 * Class Form
 * @package Ess\M2ePro\Block\Adminhtml\Walmart\Order\Edit\ShippingAddress
 */
class Form extends AbstractForm
{
    ...
    protected function _prepareForm()
    {
        ...
        $this->jsUrl->add(
            $this->getUrl(
                '*/walmart_order/saveShippingAddress',
