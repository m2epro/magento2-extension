...
namespace Ess\M2ePro\Block\Adminhtml\Ebay\Dashboard\Shipments;
...
class UrlStorage implements \Ess\M2ePro\Block\Adminhtml\Dashboard\Shipments\UrlStorageInterface
{
    ...
    public function getUrlForLateShipments(): string
    {
        ...
        return $this->getUrl([
            'status' => \Ess\M2ePro\Model\Ebay\Order::STATUS_UNSHIPPED,
    ...
    {
        return $this->getUrl(['status' => \Ess\M2ePro\Model\Ebay\Order::STATUS_UNSHIPPED]);
    }

    private function getUrl(array $filterParams): string
    {
        /** @see \Ess\M2ePro\Block\Adminhtml\Ebay\Order\Grid */
        return $this->url->getUrlWithFilter('*/ebay_order/index', $filterParams);
    }
}
