...
class Motors extends \Ess\M2ePro\Block\Adminhtml\Magento\Form\AbstractForm
{
    ...
    /**
     * @return \Ess\M2ePro\Block\Adminhtml\Ebay\Settings\Tabs\Motors
     ...
     * @throws \Zend_Db_Statement_Exception
     */
    private function addFieldsetForMotorsMarketplace(
...
HTML
     ...
     * @throws \Zend_Db_Statement_Exception
     */
    private function addFieldsetForUKMarketplace(
        \Magento\Framework\Data\Form $form,
        array $preparedAttributes
    ): void {
        $fieldset = $form->addFieldset(
...
HTML
     ...
     * @throws \Zend_Db_Statement_Exception
     */
    private function addFieldsetForDEMarketplace(
        \Magento\Framework\Data\Form $form,
        array $preparedAttributes
    ): void {
        $fieldset = $form->addFieldset(
...
HTML
     ...
     * @throws \Zend_Db_Statement_Exception
     */
    private function addFieldsetForITMarketplace(
        \Magento\Framework\Data\Form $form,
        array $preparedAttributes
    ): void {
        $fieldset = $form->addFieldset(
...
HTML
     ...
     * @throws \Zend_Db_Statement_Exception
     */
    private function addFieldsetForKTypesMarketplace(
        \Magento\Framework\Data\Form $form,
        array $preparedAttributes
    ): void {
        $fieldset = $form->addFieldset(
...
JS
     ...
     *
     * @return \Ess\M2ePro\Model\Marketplace|\Ess\M2ePro\Model\ActiveRecord\Component\Parent\AbstractModel
     * @throws \Ess\M2ePro\Model\Exception\Logic
     */
    private function getMarketplace(int $marketplaceId): \Ess\M2ePro\Model\Marketplace
    {
        return $this->ebayFactory->getObjectLoaded('Marketplace', $marketplaceId);
    }
}
