...
class Grid extends \Ess\M2ePro\Block\Adminhtml\Magento\Grid\AbstractGrid
{
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->getSelect()->where('lp.component_mode = ?', \Ess\M2ePro\Helper\Component\Ebay::NICK);
        ...
        $accountId = $this->getRequest()->getParam('ebayAccount') ?
            (int)$this->getRequest()->getParam('ebayAccount') :
            null;
        $marketplaceId = $this->getRequest()->getParam('ebayMarketplace') ?
            (int)$this->getRequest()->getParam('ebayMarketplace') :
            null;
    ...
    private function getAllItemsSubSelect(?int $accountId, ?int $marketplaceId): \Magento\Framework\DB\Select
    {
        ...
        $collection->getSelect()->where('main_table.component_mode = ?', \Ess\M2ePro\Helper\Component\Ebay::NICK);
