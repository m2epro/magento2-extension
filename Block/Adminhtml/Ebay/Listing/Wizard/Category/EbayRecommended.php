...
class EbayRecommended extends AbstractContainer
{
    use WizardTrait;
    ...
    public function _construct()
    {
        ...
        $this->_headerText = $this->__('Get suggested Categories');
    ...
    protected function _prepareLayout()
    {
        $gridBlock = $this
            ->getLayout()
            ->createBlock(
                \Ess\M2ePro\Block\Adminhtml\Ebay\Listing\Wizard\Category\EbayRecommended\Grid::class,
                '',
                [
