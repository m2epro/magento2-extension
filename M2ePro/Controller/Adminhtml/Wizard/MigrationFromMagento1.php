...
abstract class MigrationFromMagento1 extends Wizard
{
    ...
    protected function getLockItemNick()
    {
        $component = $this->getRequest()->getParam('component');

        if ($component == \Ess\M2ePro\Helper\View\Ebay::NICK) {
            return \Ess\M2ePro\Helper\Component\Ebay::MARKETPLACE_SYNCHRONIZATION_LOCK_ITEM_NICK;
        }
        if ($component == \Ess\M2ePro\Helper\View\Amazon::NICK) {
            return \Ess\M2ePro\Helper\Component\Amazon::MARKETPLACE_SYNCHRONIZATION_LOCK_ITEM_NICK;
        }
        if ($component == \Ess\M2ePro\Helper\View\Walmart::NICK) {
            return \Ess\M2ePro\Helper\Component\Walmart::MARKETPLACE_SYNCHRONIZATION_LOCK_ITEM_NICK;
        }
