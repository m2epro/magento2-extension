...
SQL
    ...
    private function upgradeEbayTemplateShipping()
    {
        $this->getTableModifier('ebay_template_shipping')
            ->renameColumn('dispatch_time', 'dispatch_time_mode', false, false)
        ...
        $this->getTableModifier('ebay_template_shipping')
            ->changeColumn('dispatch_time_mode', 'SMALLINT(5) UNSIGNED NOT NULL', '1', null, false)
            ->addColumn('dispatch_time_value', 'INT(10) UNSIGNED NOT NULL', '1', 'dispatch_time_mode', false, false)
