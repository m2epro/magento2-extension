...
class Request extends \Ess\M2ePro\Helper\AbstractHelper
{
    ...
    public function single(
        ...
        if ($this->getHelper('Server_Maintenance')->isInRealRange()) {
            ...
            throw new \Ess\M2ePro\Model\Exception\Connection($message, ['request_package'  => $package]);
        }
    ...
    public function multiple(
        ...
        if ($this->getHelper('Server_Maintenance')->isInRealRange()) {
            ...
            throw new \Ess\M2ePro\Model\Exception\Connection($message, ['request_package'  => $packages]);
        }
