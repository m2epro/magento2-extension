...
namespace Ess\M2ePro\Observer\Walmart;
...
class Order extends \Ess\M2ePro\Observer\AbstractModel
{
    ...
    private function placeReservation(\Magento\Sales\Model\Order $magentoOrder, array $itemsToSell): void
    {
        if ($this->helperFactory->getObject('Magento')->isMSISupportingVersion()) {
            ...
            $reservation->placeCompensationReservation(
                ...
                [
                    'type' => MSIReserve::EVENT_TYPE_COMPENSATING_RESERVATION_WFS_CREATED,
