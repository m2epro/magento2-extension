...
class TemplateSynchronization implements \Ess\M2ePro\Model\Servicing\Task\Analytics\CollectorInterface
{
    ...
    public function getRows(int $fromId, int $toId): iterable
    {
        ...
        foreach ($collection->getItems() as $item) {
            /** @var \Ess\M2ePro\Model\Ebay\Template\Synchronization $childItem */
            ...
            $preparedData = [
                ...
                'revise_update_title' => $childItem->getData('revise_update_title'),
                'revise_update_sub_title' => $childItem->getData('revise_update_sub_title'),
                'revise_update_description' => $childItem->getData('revise_update_description'),
                'revise_update_images' => $childItem->getData('revise_update_images'),
                'revise_update_categories' => $childItem->getData('revise_update_categories'),
                'revise_update_parts' => $childItem->getData('revise_update_parts'),
                'revise_update_shipping' => $childItem->getData('revise_update_shipping'),
                'revise_update_return' => $childItem->getData('revise_update_return'),
                'revise_update_other' => $childItem->getData('revise_update_other'),
    ...
    private function createCollection(): \Ess\M2ePro\Model\ResourceModel\Template\Synchronization\Collection
    {
        if (!$this->entityCollection) {
            $this->entityCollection = $this->templateSynchronizationEntityCollectionFactory->createWithEbayChildMode();
        }
    ...
    private function getColumns(): array
    {
        return [
            ...
            'second_table.is_custom_template',
            'second_table.list_mode',
            'second_table.list_status_enabled',
            'second_table.list_is_in_stock',
            'second_table.list_qty_calculated',
            'second_table.list_qty_calculated_value',
            'second_table.list_advanced_rules_mode',
            'second_table.list_advanced_rules_filters',
            'second_table.revise_update_qty',
            'second_table.revise_update_qty_max_applied_value_mode',
            'second_table.revise_update_qty_max_applied_value',
            'second_table.revise_update_price',
            'second_table.revise_update_title',
            'second_table.revise_update_sub_title',
            'second_table.revise_update_description',
            'second_table.revise_update_images',
            'second_table.revise_update_categories',
            'second_table.revise_update_parts',
            'second_table.revise_update_shipping',
            'second_table.revise_update_return',
            'second_table.revise_update_other',
            'second_table.relist_mode',
            'second_table.relist_filter_user_lock',
            'second_table.relist_status_enabled',
            'second_table.relist_is_in_stock',
            'second_table.relist_qty_calculated',
            'second_table.relist_qty_calculated_value',
            'second_table.relist_advanced_rules_mode',
            'second_table.relist_advanced_rules_filters',
            'second_table.stop_mode',
            'second_table.stop_status_disabled',
            'second_table.stop_out_off_stock',
            'second_table.stop_qty_calculated',
            'second_table.stop_qty_calculated_value',
            'second_table.stop_advanced_rules_mode',
            'second_table.stop_advanced_rules_filters',
        ];
    }
}
