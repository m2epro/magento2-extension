...
use Ess\M2ePro\Helper\Component\Amazon as AmazonComponent;

class Amazon extends AbstractOrdersSync
{
    protected function getComponent(): string
    {
        return AmazonComponent::NICK;
    }

    protected function getErrorText(): string
    {
        $manageUrl = $this->getUrlBuilder()->getUrl('m2epro/synchronization_log/index/referrer/amazon/');
        $supportUrl = 'support@m2epro.com';

        return (string)__(
            'Recent synchronization of Amazon orders has not been successful. Please make sure that <br>'
