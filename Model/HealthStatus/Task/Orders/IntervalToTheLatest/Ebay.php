...
use Ess\M2ePro\Helper\Component\Ebay as EbayComponent;

class Ebay extends AbstractOrdersSync
{
    protected function getComponent(): string
    {
        return EbayComponent::NICK;
    }

    protected function getErrorText(): string
    {
        $manageUrl = $this->getUrlBuilder()->getUrl('m2epro/synchronization_log/index/referrer/ebay/');
        $supportUrl = 'support@m2epro.com';

        return (string)__(
            'Recent synchronization of Ebay orders has not been successful. Please make sure that <br>'
