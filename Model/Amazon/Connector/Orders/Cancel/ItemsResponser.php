...
class ItemsResponser extends \Ess\M2ePro\Model\Amazon\Connector\Command\Pending\Responser
{
    // M2ePro\TRANSLATIONS
    ...
    public function failDetected($messageText)
    {
        ...
        foreach ($this->getOrders() as $order) {
            ...
            $order->addErrorLog('Amazon Order was not cancelled. Reason: %msg%', array('msg' => $messageText));
        }
    }
