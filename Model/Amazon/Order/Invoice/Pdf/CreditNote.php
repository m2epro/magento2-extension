...
/**
 * Class Ess\M2ePro\Model\Amazon\Order\Invoice\Pdf\CreditNote
 */
class CreditNote extends \Ess\M2ePro\Model\Amazon\Order\Invoice\Pdf\AbstractPdf
{
    //########################################
    ...
    public function getPdf()
    {
        ...
        $this->drawTitle($page, $this->getHelper('Module\Translation')->__('CREDIT NOTE'));

        $yTmp = $this->y;
        $this->drawInfoBlock($page, $this->getHelper('Module\Translation')->__('Credit Note'));
        ...
        $page->drawText($this->getHelper('Module\Translation')->__('Credit Note details'), 25, $this->y, 'UTF-8');
        $this->y -= 8;
