...
class Processor
{
    ...
    /**
     * @return \M2E\AmazonMcf\Model\Amazon\Connector\GetFulfillmentOrder\Response
     ...
     */
    public function process(string $merchantId, string $sellerFulfillmentId)
    {
        ...
        $command = $dispatcher->getConnectorByClass(
            Command::class,
            [Command::SELLER_FULFILLMENT_ID_PARAM_KEY => $sellerFulfillmentId],
            $accountId
        );
        /** @var \M2E\AmazonMcf\Model\Amazon\Connector\GetFulfillmentOrder\Response $response */
