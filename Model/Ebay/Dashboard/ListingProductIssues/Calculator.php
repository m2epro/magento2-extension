...
namespace Ess\M2ePro\Model\Ebay\Dashboard\ListingProductIssues;
...
class Calculator implements \Ess\M2ePro\Model\Dashboard\ListingProductIssues\CalculatorInterface
{
    ...
    {
        $records = $this->repository->getGroupedRecords(\Ess\M2ePro\Helper\Component\Ebay::NICK, self::ISSUES_LIMIT);
