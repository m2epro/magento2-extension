...
namespace Ess\M2ePro\Model\Cron\Task\Walmart\Order\UploadByUser;

/**
 * Class \Ess\M2ePro\Model\Cron\Task\Walmart\Order\UploadByUser\Manager
 */
class Manager extends \Ess\M2ePro\Model\AbstractModel
{
    ...
    {
        $this->getHelper('Module')->getRegistry()->deleteValue("/walmart/orders/upload_by_user/{$this->_identifier}/");
    }
