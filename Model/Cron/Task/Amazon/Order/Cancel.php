...
/**
 * Class \Ess\M2ePro\Model\Cron\Task\Amazon\Order\Cancel
 */
class Cancel extends \Ess\M2ePro\Model\Cron\Task\AbstractModel
{
    public const NICK = 'amazon/order/cancel';
    ...
    protected function processAccount(\Ess\M2ePro\Model\Account $account)
    {
        ...
        foreach ($relatedChanges as $change) {
            ...
            /** @var \Ess\M2ePro\Model\Cron\Task\Amazon\Order\Cancel\Requester $connectorObj */
