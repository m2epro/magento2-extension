...
namespace Ess\M2ePro\Model\Cron\Task\Amazon\Order\UploadByUser;

/**
 * Class \Ess\M2ePro\Model\Cron\Task\Amazon\Order\UploadByUser\Manager
 */
class Manager extends \Ess\M2ePro\Model\AbstractModel
{
    ...
    protected function getSettings($key = null)
    {
        $value = $this->getHelper('Module')->getRegistry()
            ->getValueFromJson("/amazon/orders/upload_by_user/{$this->_identifier}/");
    ...
    {
        $this->getHelper('Module')->getRegistry()->deleteValue("/amazon/orders/upload_by_user/{$this->_identifier}/");
    }
