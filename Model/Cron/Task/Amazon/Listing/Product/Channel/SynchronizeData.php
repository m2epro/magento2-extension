...
namespace Ess\M2ePro\Model\Cron\Task\Amazon\Listing\Product\Channel;

use \Ess\M2ePro\Model\Cron\Task\Amazon\Listing\Product\Channel\SynchronizeData\ProcessingRunner as ProcessingRunner;

/**
 * Class \Ess\M2ePro\Model\Cron\Task\Amazon\Listing\Product\Channel\SynchronizeData
 */
    ...
    protected function processAccount(\Ess\M2ePro\Model\Account $account)
    {
        ...
        if ($collection->getSize()) {
            ...
            $connectorObj = $dispatcherObject->getCustomConnector(
                'Cron_Task_Amazon_Listing_Product_Channel_SynchronizeData_Requester',
                [],
                $account
            );
