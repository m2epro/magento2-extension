...
class Repository extends \Ess\M2ePro\Model\AbstractModel
{
    ...
    public static $registeredTasks = [
        ...
        \Ess\M2ePro\Model\Cron\Task\Ebay\Listing\Product\KTypes\UpdateFromTecDoc::NICK => [
            'component' => \Ess\M2ePro\Helper\Component\Ebay::NICK,
            'group' => self::GROUP_EBAY,
        ],
        ...
        \Ess\M2ePro\Model\Cron\Task\Ebay\Order\RetrieveFinalFee::NICK => [
            'component' => \Ess\M2ePro\Helper\Component\Ebay::NICK,
            'group' => self::GROUP_EBAY,
        ],
        ...
        \Ess\M2ePro\Model\Cron\Task\Amazon\Order\Receive\InvoiceData::NICK => [
            'component' => \Ess\M2ePro\Helper\Component\Amazon::NICK,
            'group' => self::GROUP_AMAZON,
        ],
        ...
        \Ess\M2ePro\Model\Cron\Task\Walmart\Order\ReceiveWfs::NICK => [
            'component' => \Ess\M2ePro\Helper\Component\Walmart::NICK,
            'group' => self::GROUP_WALMART,
        ],
