...
class ChangeProcessor extends \Ess\M2ePro\Model\Template\Synchronization\ChangeProcessorAbstract
{
    ...
    public const INSTRUCTION_TYPE_REVISE_PROMOTIONS_ENABLED = 'template_synchronization_revise_promotions_enabled';
    public const INSTRUCTION_TYPE_REVISE_PROMOTIONS_DISABLED = 'template_synchronization_revise_promotions_disabled';
