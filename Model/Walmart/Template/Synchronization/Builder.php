...
/**
 * Class Ess\M2ePro\Model\Walmart\Template\Synchronization\Builder
 */
class Builder extends \Ess\M2ePro\Model\ActiveRecord\AbstractBuilder
{
    ...
    protected function prepareData()
    {
        ...
        $data['list_advanced_rules_filters'] = $this->getRuleData(
            \Ess\M2ePro\Model\Walmart\Template\Synchronization::LIST_ADVANCED_RULES_PREFIX,
            $this->rawData
        );

        $data['relist_advanced_rules_filters'] = $this->getRuleData(
            \Ess\M2ePro\Model\Walmart\Template\Synchronization::RELIST_ADVANCED_RULES_PREFIX,
            $this->rawData
        );
        ...
        $data['stop_advanced_rules_filters'] = $this->getRuleData(
            \Ess\M2ePro\Model\Walmart\Template\Synchronization::STOP_ADVANCED_RULES_PREFIX,
            $this->rawData
        );
