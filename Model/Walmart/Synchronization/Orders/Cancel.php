...
class Cancel extends AbstractModel
{
    ...
    protected function performActions()
    {
        ...
        foreach ($permittedAccounts as $account) {
            ...
            // M2ePro\TRANSLATIONS
            // The "Cancel" action for Walmart account: "%account_title%" is started. Please wait...
            $status = 'The "Cancel" action for Walmart account: "%account_title%" is started. Please wait...';
            ...
            // ---------------------------------------
            // M2ePro\TRANSLATIONS
            // The "Cancel" action for Walmart account: "%account_title%" is finished. Please wait...
            $status = 'The "Cancel" action for Walmart account: "%account_title%" is finished. Please wait...';
            $this->getActualLockItem()->setStatus(
                $this->getHelper('Module\Translation')->__($status, $account->getTitle())
            );
