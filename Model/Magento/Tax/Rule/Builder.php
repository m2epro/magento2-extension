...
{
    public const TAX_CLASS_NAME_PRODUCT = 'M2E Pro Product Tax Class';
    public const TAX_CLASS_NAME_CUSTOMER = 'M2E Pro Customer Tax Class';
    public const TAX_CLASS_NAME_SHIPPING = 'M2E Pro Shipping Tax Class';

    public const TAX_RATE_CODE_PRODUCT = 'M2E Pro Tax Rate';
    public const TAX_RULE_CODE_PRODUCT = 'M2E Pro Tax Rule';

    public const TAX_RATE_CODE_SHIPPING = 'M2E Pro Shipping Tax Rate';
    public const TAX_RULE_CODE_SHIPPING = 'M2E Pro Shipping Tax Rule';
