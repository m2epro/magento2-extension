...
namespace Ess\M2ePro\Setup\UpgradeData\v1_3_3__v1_3_4;
...
class MsrpRrp extends AbstractFeature
{
    ...
    public function execute()
    {
        $this->getTableModifier('amazon_template_description_definition')
            ->addColumn('msrp_rrp_mode', 'SMALLINT(5) UNSIGNED NOT NULL', '0', 'manufacturer_part_number_custom_attribute', false, false)
