define([
    ...
    window.WalmartTemplateCategoryCategoriesChooser = Class.create(Common, {
        ...
        showEditCategoryPopUp: function()
        {
            ...
            new Ajax.Request(M2ePro.url.get('walmart_template_category/getCategoryChooserHtml'), {
                method: 'post',
                parameters: {
        ...
        openPopUp: function(html)
        {
            ...
            self.popUp = jQuery(modalDialogMessage)
                .modal({
                           title: M2ePro.translator.translate('Change Category'),
                           type: 'slide',
                           buttons: [{
                               text: M2ePro.translator.translate('Cancel'),
                               class: 'walmart_template_category_chooser_cancel',
                               click: function () {
                                   this.closeModal();
                               }
                           }, {
                               text: M2ePro.translator.translate('Confirm'),
                               class: 'action-primary walmart_template_category_chooser_confirm',
                               id: 'save_popup_button',
                               click: function () {
                                   this.closeModal();
                                   WalmartTemplateCategoryCategoriesChooserObj.confirmCategory();
                               }
                           }]
                       });
        ...
        renderChildCategories: function(parentCategoryId)
        {
            ...
            new Ajax.Request(M2ePro.url.get('walmart_template_category/getChildCategories'), {
                method: 'post',
                parameters: {
                    marketplace_id     : $('marketplace_id').value,
        ...
        {
            var self = WalmartTemplateCategoryCategoriesChooserObj;
            var win = window.open(M2ePro.url.get('walmart_marketplace/index'));
        ...
        saveRecentCategory: function()
        {
            ...
            new Ajax.Request(M2ePro.url.get('walmart_template_category/saveRecentCategory'), {
                method     : 'post',
                parameters : {
                    marketplace_id : $('marketplace_id').value,
        ...
        search: function()
        {
            ...
            new Ajax.Request(M2ePro.url.get('walmart_template_category/searchCategory'), {
                method: 'post',
                parameters: {
                    marketplace_id: $('marketplace_id').value,
                    query:          query.trim()
        ...
        getCategoryInfoFromDictionaryByCategoryId: function(categoryId, callback)
        {
            ...
            new Ajax.Request(M2ePro.url.get('walmart_template_category/getCategoryInfoByCategoryId'), {
                method: 'post',
                asynchronous: true,
                parameters: {
                    marketplace_id : $('marketplace_id').value,
        ...
        getCategoryInfoFromDictionaryBrowseNodeId: function(browsenodeId, categoryPath, callback)
        {
            ...
            new Ajax.Request(M2ePro.url.get('walmart_template_category/getCategoryInfoByBrowseNodeId'), {
                method: 'post',
                asynchronous: true,
                parameters: {
                    marketplace_id     : $('marketplace_id').value,
