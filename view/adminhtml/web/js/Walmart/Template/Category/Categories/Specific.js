define([
    ...
    window.WalmartTemplateCategoryCategoriesSpecific = Class.create(Common, {
        ...
        initThemeAttributes: function()
        {
            ...
            new Ajax.Request(M2ePro.url.get('walmart_template_category/getVariationThemeAttributes'), {
                method: 'get',
                asynchronous: false,
                parameters: {
        ...
        initSpecifics: function()
        {
            ...
            new Ajax.Request(M2ePro.url.get('walmart_template_category/getAllSpecifics'), {
                method: 'get',
                asynchronous: true,
                parameters: {
                    marketplace_id:     $('marketplace_id').value,
