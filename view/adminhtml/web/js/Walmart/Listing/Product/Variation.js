define([
    ...
    WalmartListingProductVariation.prototype = Object.extend(new Common(), {
        ...
        showSwitchToIndividualModePopUp: function (title) {
            ...
            new Ajax.Request(M2ePro.url.get('walmart_listing_product_variation/getSwitchToIndividualModePopUp'), {
                method: 'post',
        ...
        showSwitchToParentModePopUp: function () {
            ...
            new Ajax.Request(M2ePro.url.get('walmart_listing_product_variation/getSwitchToParentModePopUp'), {
                method: 'post',
                onSuccess: function (transport) {
        ...
        showEditPopup: function (popupTitle) {
            ...
            new Ajax.Request(M2ePro.url.get('walmart_listing_product_variation_individual/getEditPopup'), {
                method: 'get',
                parameters: {
        ...
        resetListingProductVariation: function ()
        {
            ...
            new Ajax.Request(M2ePro.url.get('walmart_listing_product/variationReset'), {
                method: 'get',
                parameters: {
                    listing_product_id: this.listingProductId
                },
        ...
        showManagePopup: function (popupTitle)
        {
            ...
            new Ajax.Request(M2ePro.url.get('walmart_listing_product_variation_individual/getManagePopup'), {
                method: 'get',
                parameters: {
                    listing_product_id: this.listingProductId
                },
        ...
        editAction: function (variationData)
        {
            ...
            new Ajax.Request(M2ePro.url.get('walmart_listing_product_variation_individual/edit'), {
                method: 'post',
        ...
        manageAction: function (variationData)
        {
            ...
            new Ajax.Request(M2ePro.url.get('walmart_listing_product_variation_individual/manage'), {
                method: 'post',
                parameters: parameters,
                onSuccess: (function (transport) {
        ...
        manageGenerateAction: function (unique)
        {
            ...
            new Ajax.Request(M2ePro.url.get('walmart_listing_product_variation_individual/generate'), {
                method: 'post',
                parameters: {
