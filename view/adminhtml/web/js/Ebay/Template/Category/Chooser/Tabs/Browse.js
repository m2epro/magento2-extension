define([
    ...
    window.EbayTemplateCategoryChooserTabsBrowse = Class.create(Common, {
        ...
        getSelectedCategories: function () {
            var self = EbayTemplateCategoryChooserTabsBrowseObj;
        ...
        renderChildCategories: function (parentCategoryId) {
            ...
            new Ajax.Request(M2ePro.url.get('ebay_category/getChildCategories'), {
                ...
                parameters: {
                    ...
                    "account_id": EbayTemplateCategoryChooserObj.getAccountId(),
        ...
        prepareDomStructure: function (categoryId, parentDiv) {
            ...
            childrenSelect.onchange = function () {
                EbayTemplateCategoryChooserTabsBrowseObj.onSelectCategory(this);
            };
