define([
    ...
    window.EbayCategorySpecificValidatorGrid = Class.create(Grid, {
        ...
        prepareActions: function () {
            this.actions = {
                validateEbayCategorySpecificAction: (function () {
        ...
        validate: function (listingProductIds) {
            ...
            var sendPart = function (listingProductIds, totalCount, partSize) {
                ...
                new Ajax.Request(M2ePro.url.get('ebay_category_specific_validation_url'), {
                    method: 'post',
                    parameters: {
