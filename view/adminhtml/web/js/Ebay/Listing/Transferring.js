define([
    ...
    window.EbayListingTransferring = Class.create(Common, {
        ...
        {
            new Ajax.Request(M2ePro.url.get('ebay_listing/transferring/index', {step: 1}), {
                method: 'post',
                asynchronous: true,
                parameters: {
                    ...
                    jQuery(modalDialogMessage).modal({
                        ...
                        buttons: [
                            ...
                            },
                            {
                                ...
                                click: function () {
                                    EbayListingTransferringObj.popupContinue();
                                }
                            }
                        ],
                        closed: function() {
        ...
        refreshListings: function()
        {
            ...
            new Ajax.Request(M2ePro.url.get('ebay_listing_transferring/getListings'), {
                method: 'post',
                asynchronous: true,
                parameters: {
                    account_id     : this.getTargetAccount(),
