define([
    ...
    'M2ePro/Ebay/Listing/Wizard/Product/Category/Settings/Grid'
], function (jQuery, modal, MessageObj) {

    window.EbayListingWizardProductCategorySettingsModeProductGrid = Class.create(EbayListingWizardProductCategorySettingsGrid, {
